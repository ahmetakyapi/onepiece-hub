  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span className="absolute inset-0 flex items-center justify-center bg-ocean-deep/45">
      ...
      <div className="min-w-0 flex-1">
        <p className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.14em] text-gold/70">
        ...
        <p className="stat-number truncate text-[10px] text-pirate-muted">
