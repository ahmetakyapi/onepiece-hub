...
/* Orb renkleri token'dan okunur — tema değişince ambiyans da döner. */
const HERO_ORBS = [
  { color: 'rgb(var(--gold) / 0.35)', size: 280, x: '8%', y: '10%', delay: 0 },
  { color: 'rgb(var(--sea) / 0.3)', size: 220, x: '70%', y: '20%', delay: 1.5 },
  { color: 'rgb(var(--luffy) / 0.25)', size: 180, x: '55%', y: '65%', delay: 3 },
  { color: 'rgb(var(--fruit) / 0.22)', size: 160, x: '30%', y: '75%', delay: 2 },
]
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {topBattles.map((battle, i) => {
              ...
              const medalColor = i === 0 ? 'text-gold' : i === 1 ? 'text-pirate-text/70' : 'text-accent-amber'
              const medalBg = i === 0 ? 'bg-gold/10 border-gold/25' : i === 1 ? 'bg-pirate-text/[0.06] border-pirate-text/20' : 'bg-accent-amber/10 border-accent-amber/25'
              return (
                <Link
                  key={battle.slug}
                  href="/battles"
                  ...
                  <div className="mt-auto space-y-2">
                    <div>
                      <div className="mb-1 flex items-center gap-1.5 text-[10px]">
                        ...
                        <span className="ml-auto font-mono font-bold text-gold">{battle.powerLevel}/5</span>
                      </div>
                    ...
                    <div>
                      <div className="mb-1 flex items-center gap-1.5 text-[10px]">
                        ...
                        <span className="ml-auto font-mono font-bold text-luffy">{battle.emotionalWeight}/5</span>
                      </div>
                      <div className="h-1.5 overflow-hidden rounded-full bg-ocean-surface">
                        <div
